...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = pct_womenbike),
          color = "transparent")+
       scale_fill_viridis(option="D")+
         
  geom_sf(data = acsTractsPHL.2019.sf %>%
            filter(Neighborhood == "WashingtonSquare_West") %>%
            st_union(),
          color = "white",
          fill = "transparent")+
  ...
  labs(
    title = "Biking Women in Washington Square West in 2019",
    subtitle = 
   "Percent of Washington Square West residents recorded
   as women that commute to work on bike.",
